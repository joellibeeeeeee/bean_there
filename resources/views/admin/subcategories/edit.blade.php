...
<div style="max-width: 500px; margin: 40px auto;">
    <div style="background: white; border-radius: 25px; padding: 40px; box-shadow: 0 10px 40px rgba(0,0,0,0.1); font-family: 'Poppins', sans-serif;">
        <h1 style="font-family: 'Cooper Black', serif; color: #4A2C2A; margin: 0 0 8px 0; font-size: 1.8rem;">Edit Subcategory</h1>
        <p style="color: #666; font-size: 14px; margin-bottom: 25px;">Update the subcategory details.</p>
        ...
        <form method="POST" action="{{ route('admin.subcategories.update', $subcategory) }}">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" value="{{ old('name', $subcategory->name) }}" placeholder="e.g. Cakes & Slices" 
            ...
            <div style="margin-bottom: 25px;">
                ...
                <textarea name="description" rows="3" placeholder="Brief description of this subcategory"
                          style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #F0F2F5; outline: none; box-sizing: border-box; font-family: 'Poppins', sans-serif; resize: vertical;">{{ old('description', $subcategory->description) }}</textarea>
            </div>
